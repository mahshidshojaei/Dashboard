...
function create(prototype3, properties) {
  const proto = isObject(prototype3) ? Object.create(prototype3) : {};
  if (properties != null) {
...
function mergeWith(object, ...otherArgs) {
  ...
  for (let i = 0; i < sources.length; i++) {
    const source = sources[i];
    result = mergeWithDeep(result, source, merge4, /* @__PURE__ */ new Map());
  }
  return result;
}
...
var isArrayBuffer3 = kindOfTest("ArrayBuffer");
